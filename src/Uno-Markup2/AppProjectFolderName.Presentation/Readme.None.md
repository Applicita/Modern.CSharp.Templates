...
This C# Markup 2 Presentation project was created with `dotnet new mcs-uno-markup2 --presentation none` (template version [`Modern.CSharp.Templates 2.0.0`](https://www.nuget.org/packages/Modern.CSharp.Templates/1.5.0))
